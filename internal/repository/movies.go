...
func (m MovieModel) GetAll(title string, genres []string, filters Filters) ([]*entity.Movie, Metadata, error) {
	query := fmt.Sprintf(`
...
func ValidateMovie(v *validator.Validator, movie *entity.Movie) {
